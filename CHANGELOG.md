...
## [1.0.1](https://github.com/flxbl-io/auth-environment-with-lock/compare/v1.0.0...v1.0.1) (2026-01-19)


### Bug Fixes

* correct package name in package-lock.json ([2dcec84](https://github.com/flxbl-io/auth-environment-with-lock/commit/2dcec844bda371b7a3bd842448dcbbad6ac32c09))
* stream sfp CLI stderr to show headers and progress ([403b31a](https://github.com/flxbl-io/auth-environment-with-lock/commit/403b31ade7b34252dca059826890c1425a4de630))
